...
<body>
    ...
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="#"><img src="{{ asset('frontend/img/logo2.png')}}" alt=""></a>
        </div>
        ...
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
                ...
                <li><a href="https://linktr.ee/staffseekersbali">Contact</a></li>
            </ul>
        </nav>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__left">
                            <ul>
                                <li><i class="fa fa-envelope"></i> baliartmarkets@gmail.com</li>
                                <li>Free shipping for all of Indonesia!</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                ...
                <div class="col-lg-9">
                    <div class="hero__item set-bg" data-setbg="{{ asset('frontend/img/hero/banner.jpg')}}">
                        <div class="hero__text">
                            <span>BALI ART</span>
                            <h2>Marketplace Seni Bali <br />100% Original</h2>
                            <p>Temukan Karya Seni Terbaik Untukmu</p>
                            <a href="{{ route('shop.index') }}" class="primary-btn">CARI KARYA</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        ...
                        <ul>
                            <li>Address: Jl. WR Supratman No.302, Kesiman Kertalangu</li>
                            <li>Phone: +6287-8609-3500</li>
